...
public interface TaskCompletionRepository extends JpaRepository<TaskCompletion, Long> {
    ...
    Optional<TaskCompletion> findByIdAndUserIdAndTaskId(Long id, Long userId, Long taskId);

    Optional<TaskCompletion> findFirstByUserIdAndTaskIdAndIdNotOrderByCompletedAtDesc(
            Long userId,
            Long taskId,
            Long id
    );

...
export const options = {
  vus: envNumber("SOAK_VUS", 60),
  duration: envDuration("SOAK_DURATION", "2h"),
  thresholds: {
...
export default function (setupData) {
  ...
  const writeRatioPercent = envNumber("WRITE_RATIO_PERCENT", 15);
  const sleepSeconds = envNumber("SLEEP_SECONDS", 0.8);
